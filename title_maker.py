...
# Load the tokenizer
tokenizer = AutoTokenizer.from_pretrained("Abstract_to_Title/llama_1B_lora_finetuned")
...
model = PeftModel.from_pretrained(base_model, "Abstract_to_Title/llama_1B_lora_finetuned")
